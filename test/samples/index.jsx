...
<article class="article heti heti--classic select-text bg-white max-w-6xl p-8" style={style}>
    <h1 class="article__title">赫蹏</h1>
    <slot />
    <blockquote>
        中文网字计划的文章测试，采用开源项目 <a href="https://github.com/sivan/heti">赫蹏</a> 的网页进行检测，计划修改了部分代码，使得中文网字计划可以查看不同字体的效果。
    </blockquote>
    <blockquote>
        古代称用以书写的小幅绢帛。后亦以借指纸。《汉书·外戚传下·孝成赵皇后》：「武（籍武）发篋中，有裹药二枚，赫蹏书。」<u
            >颜师古</u
        >注：「<u>邓展</u>曰：『赫音兄弟鬩墙之鬩。』<u>应劭</u>曰：『赫蹏，薄小纸也。』」<u>宋</u><u
            >赵彦卫</u
        >
    ...
    <p>
        <ruby class="heti-ruby--inline">赫<rp>(</rp><rt lang="zh-Latn">hè</rt><rp>)</rp></ruby><ruby
            class="heti-ruby--inline">蹏<rp>(</rp><rt lang="zh-Latn">tí</rt><rp>)</rp></ruby
    ...
    <ul>
        ...
        <li>
            兼容<i>normalize.css</i>、<i>CSS Reset<sup><a id="ref-01" href="#fn-01">[1]</a></sup></i
            >等常见样式重置；
        </li>
        <li>移动端支持；</li>
        <li>……</li>
...
&lt;/article&gt;</code></pre>
    ...
    <small
        >注：赫蹏是正文区域的样式增强，不是<i>normalize.css</i>或<i>CSS Reset</i>的替代。因此<b
            >不建议</b
        >将它作用在根标签（如<code>&lt;body&gt;</code>或<code
    ...
    <details>
        ...
        <p>
            为容器元素<code>&lt;div class=&quot;heti&quot;&gt;</code>添加名为<code
                >heti--ancient</code
            >的class即可实现古文版式：
        </p>
    ...
    <details>
        ...
        <ul>
            <li>
                诗词：为容器元素<code>&lt;div class=&quot;heti&quot;&gt;</code>添加名为<code
                    >heti--poetry</code
                >的class实现诗词版式：
...
&lt;/div&gt;</code></pre>
            ...
            <li>
                诗节：在古文版式<code>&lt;div class=&quot;heti heti--ancient&quot;&gt;</code
                >中，为诗句添加名为<code>heti-verse</code>的class可以将其居中显示：
...
&lt;/div&gt;</code></pre>
            ...
            <li>
                搭配使用标点悬挂<code>&lt;span class=&quot;heti-hang&quot;&gt;</code>、元信息<code
                    >&lt;span class=&quot;heti-meta heti-small&quot;&gt;</code
                >来丰富展示效果。
            </li>
        </ul>
    </details>
    <details open>
        ...
        <section class="demo">
            <div class="heti heti--ancient">
                <h2>
                    一剪梅·红藕香残玉簟秋<span class="heti-meta heti-small"
                        >[宋]<abbr title="号易安居士">李清照</abbr></span
                    >
                </h2>
                <p class="heti-verse heti-x-large">
                    红藕香残玉簟秋。轻解罗裳，独上兰舟<span class="heti-hang">。</span><br />
            ...
            <div class="heti heti--poetry">
                <h2>
                    赠汪伦<span class="heti-meta heti-small"
                        >[唐]<abbr title="号青莲居士">李白</abbr></span
                    >
                </h2>
                <p class="heti-verse heti-x-large">
    ...
    <details>
        ...
        <p>
            为容器元素<code>&lt;div class=&quot;heti&quot;&gt;</code>添加名为<code
                >heti--annotation</code
            >的class后，搭配<code>&lt;ruby&gt;</code>元素即可实现整齐的行间注效果：
        </p>
            ...
            <div class="heti heti--ancient heti--annotation">
                ...
                <p>
                    <u title="名丁的厨工。先秦古书往往以职业放在人名前"
                        ><ruby><rb>庖</rb><rp>(</rp><rt lang="zh-Latn">páo</rt><rp>)</rp></ruby
                        >丁</u
                    >为文惠君解牛，手之所触，肩之所倚，足之所履，膝之所<u title="支撑，接触"
                        ><ruby><rb>踦</rb><rp>(</rp><rt lang="zh-Latn">yǐ</rt><rp>)</rp></ruby></u
                    >，<u title="砉然：砉，又读xū，象声词。砉然，皮骨相离的声音"
                        ><ruby><rb>砉</rb><rp>(</rp><rt lang="zh-Latn">huā</rt><rp>)</rp></ruby
                        >然</u
                    ><ruby><rb>向</rb><rp>(</rp><rt lang="zh-Latn">xiǎng</rt><rp>)</rp></ruby
                    >然，奏刀<u title="騞然：象声词，形容比砉然更大的进刀解牛声"
                        ><ruby><rb>騞</rb><rp>(</rp><rt lang="zh-Latn">huō</rt><rp>)</rp></ruby
                        >然</u
                    >，莫不中音。合于《桑林》之舞，乃中《经首》之会。
                </p>
                <p>
                    文惠君曰：「嘻，善哉！技<u title="通「盍」，何，怎样"
                        ><ruby><rb>盖</rb><rp>(</rp><rt lang="zh-Latn">hé</rt><rp>)</rp></ruby></u
                    >至此乎？」
                </p>
                <p>
                    庖丁释刀对曰：「臣之所好者，道也，进乎技矣。始臣之解牛之时，所见无非牛者。三年之后，未尝见全牛也。方今之时，臣以神遇而不以目视，官知止而<u
                        title="指精神活动">神欲</u
                    >行。依乎<u title="指牛的生理上的天然结构">天理</u>，<u title="击入大的缝隙"
                        >批大<ruby><rb>郤</rb><rp>(</rp><rt lang="zh-Latn">xì</rt><rp>)</rp></ruby
                        ></u
                    >，<u title="顺着（骨节间的）空处进刀"
                        >导大<ruby><rb>窾</rb><rp>(</rp><rt lang="zh-Latn">kuǎn</rt><rp>)</rp></ruby
                        ></u
                    >，<u title="依">因</u>其<u title="指牛体本来的结构">固然</u>，技经肯<ruby
                        ><rb>綮</rb><rp>(</rp><rt lang="zh-Latn">qìng</rt><rp>)</rp></ruby
                    >之未尝，而况大<ruby
                        ><rb>軱</rb><rp>(</rp><rt lang="zh-Latn">gū</rt><rp>)</rp></ruby
                    >乎！良庖岁更刀，割也；族庖月更刀，折也。今臣之刀十九年矣，所解数千牛矣，而刀刃若新发于<ruby
                        ><rb>硎</rb><rp>(</rp><rt lang="zh-Latn">xíng</rt><rp>)</rp></ruby
                    >。彼节者有间，而刀刃者无厚；以无厚入有间，恢恢乎其于<em>游刃必有余地</em
                    >矣，是以十九年而刀刃若新发于硎。虽然，每至于族，吾见其难为，<ruby
                        ><rb>怵</rb><rp>(</rp><rt lang="zh-Latn">chù</rt><rp>)</rp></ruby
                    >然为戒，视为止，行为迟。动刀甚微，<ruby
                        ><rb>謋</rb><rp>(</rp><rt lang="zh-Latn">huò</rt><rp>)</rp></ruby
                    >然已解，如土委地。提刀而立，为之四顾，为之<ruby
                        ><rb>踌</rb><rp>(</rp><rt lang="zh-Latn">chóu</rt><rp>)</rp><rb>躇</rb><rp
                            >(</rp
                        ><rt lang="zh-Latn">chú</rt><rp>)</rp></ruby
                    >满志，善刀而藏之。」
                </p>
            ...
            <div lang="en-US">
                ...
                <p>
                    <q
                        ...
                        it, simply because it is pain...</q
                    >
                </p>
                <p>
                    <dfn>Lorem Ipsum</dfn> is simply dummy text of the printing and typesetting industry.
                ...
                <p>
                    ...
                    <cite>"de Finibus Bonorum et Malorum"</cite> by Cicero are also reproduced in their
                    exact original form, accompanied by English versions from the 1914 translation by
                    H. Rackham.
                </p>
            </div>
        </section>
    ...
    <p>
        赫蹏项目的初衷很简单：它不作为一个CSS
        Reset出现，而是根据通行的中文排版规范，对网页正文区域进行排版样式增强。在部分CSS特性尚未有浏览器支持前，可通过JavaScript实现功能补充。
    </p>
    <h3>文字</h3>
    <p>
        参考《中文排版需求<sup><a id="ref-02" href="#fn-02">[2]</a></sup
        >》中描述的常用书籍排版字体，赫蹏提供了黑体、宋体和<u title="以正文宋体、标题楷体构成的搭配"
            >传统</u
    ...
    <details>
        ...
        <p>
            通过源码引用的方式覆盖`_variables.scss`文件中`$chinese-quote-set`变量的值为`cn`即可将引号设为GB/T
            15834-2011的国家标准。
        </p>
    </details>
    <h3>间距</h3>
        ...
        <section class="section">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >&lt;a href=&quot;https://github.com/sivan/heti&quot;
                            title=&quot;赫蹏&quot;&gt;heti.css&lt;/a&gt;</code
                        >
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >&lt;abbr title=&quot;Cascading Style Sheets&quot;&gt;CSS&lt;/abbr&gt;</code
                        >
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >此时来自&lt;u
                            title=&quot;位于山东省聊城市阳谷县城东&quot;&gt;景阳冈&lt;/u&gt;的&lt;u&gt;武松&lt;/u&gt;大喝一声：&lt;q&gt;纳命来！&lt;/q&gt;</code
                        >
                    </td>
                    <td>
                        此时来自<u title="位于山东省聊城市阳谷县城东">景阳冈</u>的<u>武松</u
                        >大喝一声：<q>纳命来！</q>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <code
                            >这次考试，我考了&lt;del
                            datetime=&quot;17:00:00&quot;&gt;58&lt;/del&gt;&lt;ins
                            datetime=&quot;18:15:00&quot;&gt;98&lt;/ins&gt;分呢！</code
                        >
                    </td>
                    <td>
                        这次考试，我考了<del datetime="17:00:00">58</del><ins datetime="18:15:00"
                            >98</ins
                        >分呢！
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <code
                            >因为谁也不认识，所以最后我们决定念&lt;s&gt;d&iacute;&lt;/s&gt;t&iacute;。</code
                        >
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >窃&middot;格瓦拉曾经说过：&lt;q&gt;打工是不可能打工的。&lt;/q&gt;</code
                        >
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >&lt;dfn&gt;窃&middot;格瓦拉&lt;/dfn&gt;，中国大陆网络红人、罪犯。被奉为百度「戒赌吧」400万会员的「精神领袖」。</code
                        >
                    </td>
                    <td>
                        <dfn>窃·格瓦拉</dfn
                        >，中国大陆网络红人、罪犯。被奉为百度「戒赌吧」400万会员的「精神领袖」。
                    </td>
                </tr>
                <tr>
                    <td>标记</td>
                ...
                <tr>
                    ...
                    <td>
                        <code
                            >我们&lt;span
                            class=&quot;heti-em&quot;&gt;必将&lt;/span&gt;战胜这场疫情。</code
                        >
                    </td>
    ...
    <p>
        由于部分CSS特性尚未有浏览器支持等原因，可选择使用增强脚本进行排版效果优化。在页面的<code
            >&lt;/body&gt;</code
        >标签前引入JavaScript脚本后初始化即可：
    </p>
...
&lt;/script&gt;</code></pre>
    ...
    <ul>
        <li>
            中英文混排优化：无论你的输入习惯是否在中西文之间留有「空格」<sup
                ><a id="ref-03" href="#fn-03">[3]</a></sup
            >，都会统一成标准间距（¼字宽的空白）；
        </li>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="3">
                <div class="heti-skip">
                    <b>Hello, world!</b
                    >是大家第一次学习Programming时最常写的demo，它看似简单，但对有些人来说寥寥数语有时也会产生bug。
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <th>默认文本</th>
            <td colspan="3">
                <blockquote class="heti-skip" style="margin-inline-start: 0; margin-inline-end: 0">
                    古代称用以书写的小幅绢帛。后亦以借指纸<mark>。《</mark
                    >汉书·外戚传下·孝成赵皇后<mark>》：「</mark>武（籍武
                    ）发篋中，有裹药二枚，赫蹏书。」<u>颜师古</u>注：「<u>邓展</u
                    >曰：『赫音兄弟鬩墙之鬩。』<u>应劭</u>曰：『赫蹏，薄小纸也。』」<u>宋</u><u
                        >赵彦卫</u
                    >《云麓漫钞》卷七：「《赵后传》所谓『赫蹏』者，注云『薄小纸』，然其寔亦縑帛。」
                </blockquote>
            </td>
